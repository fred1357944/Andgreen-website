  ...
  return (
    ...
    >
      ...
      <section className="py-16 bg-white text-center" data-aos="fade-up">
        <h2 className="text-3xl lg:text-4xl font-morisawa text-light-gray mb-6">
          我們的願景
        </h2>
        <p className="text-gray-600 font-morisawa text-lg lg:text-xl max-w-3xl mx-auto leading-relaxed">
          綠亦有限公司將自然與科技結合，設計創新產品，致力於提升城市空氣品質，推動可持續發展。
        </p>
      </section>

      {/* Contact Section */}
      <section className="py-16 text-center bg-gray-100" data-aos="fade-up">
        <h2 className="text-3xl lg:text-4xl font-futura text-light-gray mb-6">
          聯絡我們
        </h2>
